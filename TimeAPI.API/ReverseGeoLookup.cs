...
namespace TimeAPI.API
{
    public static class ReverseGeoLookup
    {
            ...
            out string Address_neighborhood)
        {
            ...
            try
            {
                //25.1864194,55.2605904
                doc.Load("https://maps.googleapis.com/maps/api/geocode/xml?latlng=" + latitude + "," + longitude + "&sensor=false&new_reverse_geocoder=false&key=AIzaSyDRhSfZnKy-1wxL8xCX0kpRXUh1OXhcrOE");
