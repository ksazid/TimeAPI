        ...
        public void Add(CostProjectTask entity)
        {
            entity.id = ExecuteScalar<string>(
                    sql: @"INSERT INTO dbo.cost_task
                                  (id, empid, task_name, task_desc, unit, qty, priority_id, status_id, assigned_empid, due_date, created_date, createdby, is_approver, is_approver_id)
                           VALUES (@id, @empid, @task_name, @task_desc, @unit, @qty, @priority_id, @status_id, @assigned_empid, @due_date, @created_date, @createdby, @is_approver, @is_approver_id);
