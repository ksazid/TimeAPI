...
{
    public class ActivityDashboardRepository : RepositoryBase, IActivityDashboardRepository
    {
        public ActivityDashboardRepository(IDbTransaction transaction) : base(transaction)
        {
        }

        #region

        public void Add(ActivityDashboard entity)
        {
            Execute(
                sql: @"",
                param: entity
        ...
        public void Update(ActivityDashboard entity)
        {
            Execute(
                sql: @"",
                param: entity
        ...
        public IEnumerable<ActivityDashboard> All()
        {
            return Query<ActivityDashboard>(
                sql: ""
            );
        }

        public ActivityDashboard Find(string key)
        {
            return QuerySingleOrDefault<ActivityDashboard>(
                sql: "",
                param: new { key }
            );
        }
